...
describe('browser handoff', () => {
  it('offers explicit resume without exposing page observations during private entry', () => {
    const html = renderToStaticMarkup(<BrowserIsland session={{
      id: 'fixture', profile_id: 'default', objective: 'Browse', revision: 1,
      state: 'private', detail: 'Private input', tabs: [{ id: 'tab', url: 'https://secret.example' }]
    }} />)
  ...
  it('keeps stopping explicit and disables another stop', () => {
    const html = renderToStaticMarkup(<BrowserIsland session={{
      id: 'fixture', profile_id: 'default', objective: 'Browse', revision: 2,
      state: 'stopping', detail: 'Stopping automation; please wait before typing.', tabs: []
    }} />)
