...
first launch it can install the Marvi Agent runtime into `HERMES_HOME`
...
- **Marvi Agent** runs as a headless `hermes serve` process and exposes the
...
Desktop supports a managed local backend, explicit remote gateways, and Marvi
