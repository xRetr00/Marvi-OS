...
Built for [Hermes Agent](https://github.com/xRetr00/Marvi). Usable in any coding agent. Canonical source lives here; synced to [`xRetr00/Marvi/skills/creative/ascii-video`](https://github.com/xRetr00/Marvi/tree/main/skills/creative/ascii-video) via PR.
