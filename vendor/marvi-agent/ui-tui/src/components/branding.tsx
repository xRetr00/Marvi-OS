...
const TAG_FULL = 'NeuRetro Labs Research · Messenger of the Digital Gods'
const TAG_MID = 'Messenger of the Digital Gods'
const TAG_TINY = 'NeuRetro Labs Research'
const HIDE_BELOW = 34
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · NeuRetro Labs Research</Text>
          </Text>
