...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$MARVI_MESSAGING_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_marvi_dir("platforms/whatsapp/session", "whatsapp/session")
