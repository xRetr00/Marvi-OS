...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Marvi session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Marvi session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Marvi Messaging"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Marvi Messaging to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Marvi gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Marvi session in it",
