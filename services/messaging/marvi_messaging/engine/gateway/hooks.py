...
Hooks are discovered from ~/.marvi/hooks/ directories, each containing:
...
HOOKS_DIR = get_marvi_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"marvi_hook_{hook_name}"
