...
# ``data:`` field before Marvi receives a completion chunk.  Keeping this
...
#
# See: https://github.com/xRetr00/Marvi-OS/issues/27344
...
# case: a stream dies mid-response and Marvi persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # runtime_support.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from runtime_support.plugins import get_plugin_error_classification
