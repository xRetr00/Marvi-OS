...
_SESSION_CWD: ContextVar = ContextVar("MARVI_MESSAGING_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the Marvi
    # source tree itself, which is a legitimate workspace when the user is
    # developing Marvi (per-surface policy for fallback-picked directories
