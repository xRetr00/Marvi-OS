"""Language Server Protocol (LSP) integration for Marvi Messaging.

Marvi runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``marvi chat`` exit would leak pyright processes that
