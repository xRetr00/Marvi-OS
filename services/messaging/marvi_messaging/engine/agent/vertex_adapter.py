"""Vertex AI (Google Cloud) adapter for Marvi Messaging.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Marvi to use Gemini models via Google Cloud with
...
# who installed plain `marvi-messaging` and only later selected a Gemini model.
try:
