"""Core NeMo Relay adapter for Marvi tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Marvi tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Marvi Relay tool execution cannot run on an active event-loop thread"
    )
