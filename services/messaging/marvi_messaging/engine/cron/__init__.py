"""
Cron job scheduling system for Marvi Messaging.
...
Cron jobs are executed automatically by the gateway daemon:
    marvi gateway install    # Install as a user service
    sudo marvi gateway install --system  # Linux servers: boot-time system service
    marvi gateway            # Or run in foreground
