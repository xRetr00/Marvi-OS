...
``_check_spotify_available()`` — when the user has not run ``marvi auth
spotify``, the tools remain registered (so they appear in ``marvi
...
The Spotify auth flow (``marvi auth spotify``), CLI plumbing, and docs
