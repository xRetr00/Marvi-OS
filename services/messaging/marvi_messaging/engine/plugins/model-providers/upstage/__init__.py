...
# When the user hasn't picked a reasoning effort, Marvi passes
...
# ON at this effort — matching the "medium (default)" that Marvi' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Marvi' effort vocabulary onto Solar's accepted set. xhigh/max/
