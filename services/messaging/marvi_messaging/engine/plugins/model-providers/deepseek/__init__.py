...
the contract that subsequent turns echo it back; combined with how Marvi
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Marvi remaps
the retired IDs in ``runtime_support.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Marvi, so they are not listed here.
    """
