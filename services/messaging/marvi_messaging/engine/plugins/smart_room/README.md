...
python plugins/smart_room/scripts/create_owntracks_config.py `
  ...
  --env-file "$env:LOCALAPPDATA\marvi\.env" `
...
## Spec
See `D:\marvi-messaging\docs\superpowers\specs\2026-07-14-marvi-smart-room-plugin-v0.3.md` for the current v0.4 revision (the original path is retained for existing links).
