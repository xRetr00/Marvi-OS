...
required — uses aiohttp which is already a Marvi dependency.
...
def interactive_setup() -> None:
    ...
    ``runtime_support/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Marvi delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # runtime_support/setup.py::_setup_mattermost function.
