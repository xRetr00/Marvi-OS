...
Config: ~/.marvi/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.marvi/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_marvi_home()`` helper (MARVI_MESSAGING_HOME-aware and
...
RULES_FILE = get_marvi_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_marvi_home() / "feishu_comment_pairing.json"
