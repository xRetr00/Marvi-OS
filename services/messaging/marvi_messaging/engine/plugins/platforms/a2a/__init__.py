"""
A2A (Agent-to-Agent) plugin for Marvi Messaging.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes Marvi as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`marvi gateway setup` flow for A2A."""
    ...
    print_info("Expose Marvi as an A2A-discoverable agent and call other A2A agents.")
