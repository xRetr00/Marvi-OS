...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Marvi gateway adapter.

    Each inbound phone number gets its own Marvi session (multi-tenant).
...
# static dict in runtime_support/gateway.py, and the _send_sms dispatch in
