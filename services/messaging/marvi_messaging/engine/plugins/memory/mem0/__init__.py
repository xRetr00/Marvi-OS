...
Configuration
-------------
Secret (lives in $MARVI_MESSAGING_HOME/.env or the environment):
...
Behavioral settings (live in $MARVI_MESSAGING_HOME/mem0.json, set via `marvi memory
setup`):
  ...
  agent_id           — Agent identifier (default: marvi)
...
def _load_config() -> dict:
    """Load config from env vars, with $MARVI_MESSAGING_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "marvi"),
        "oss": {},
    }
    ...
    config_path = get_marvi_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, marvi_home):
        """Write config to $MARVI_MESSAGING_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $MARVI_MESSAGING_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "marvi")
