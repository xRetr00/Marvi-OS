...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.marvi/skills/creative/pixel-art/scripts"))
...
```bash
cd ~/.marvi/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Marvi installs package this)
