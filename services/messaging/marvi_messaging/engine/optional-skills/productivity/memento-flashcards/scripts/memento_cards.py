...
Data file: $MARVI_MESSAGING_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_MARVI_MESSAGING_HOME = Path(os.environ.get("MARVI_MESSAGING_HOME", Path.home() / ".marvi"))
DATA_DIR = _MARVI_MESSAGING_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
