...
4. Name the token (e.g., "Marvi Messaging"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${MARVI_MESSAGING_HOME:-~/.marvi}/.env`:
...
```bash
CANVAS="python $MARVI_MESSAGING_HOME/skills/productivity/canvas/scripts/canvas_api.py"
