...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Marvi Messaging
license: MIT
...
Helper script path: `~/.marvi/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.marvi/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.marvi/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.marvi/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
