...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by Marvi Messaging
license: MIT
...
Helper script path: ~/.marvi/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.marvi/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.marvi/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.marvi/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.marvi/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.marvi/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.marvi/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
