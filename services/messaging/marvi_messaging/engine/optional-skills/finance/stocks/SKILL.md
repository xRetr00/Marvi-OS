...
version: 0.1.0
author: Mibay (Mibayy), Marvi Messaging
license: MIT
...
```
SCRIPT=~/.marvi/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.marvi/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
