...
def _state_dir() -> Path:
    ...
    # Default: $MARVI_MESSAGING_HOME/watcher-state/, falling back to ~/.marvi/watcher-state/.
    marvi_home = os.environ.get("MARVI_MESSAGING_HOME") or str(Path.home() / ".marvi")
    return Path(marvi_home) / "watcher-state"
