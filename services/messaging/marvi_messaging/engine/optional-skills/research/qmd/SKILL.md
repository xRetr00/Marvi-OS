...
metadata:
  marvi:
    ...
    related_skills: [obsidian, marvi-messaging, arxiv]
---
...
Marvi Messaging via the native MCP client. This is the preferred
...
Then configure Marvi Messaging to connect via HTTP:
