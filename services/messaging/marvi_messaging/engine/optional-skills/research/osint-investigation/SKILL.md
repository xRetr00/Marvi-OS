...
author: Marvi Messaging (adapted from ShinMegamiBoson/OpenPlanter, MIT)
license: MIT
metadata:
  marvi:
...
# $MARVI_MESSAGING_OSINT_CACHE/icij/ (default: ~/.cache/marvi-osint/icij/).
...
# Set MARVI_MESSAGING_OSINT_UA=your-app/1.0 (your@email) to identify yourself
