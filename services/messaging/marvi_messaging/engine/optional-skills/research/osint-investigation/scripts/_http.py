...
DEFAULT_UA = (
    "marvi-osint-investigation/0.2 "
    "(+https://github.com/xRetr00/Marvi; "
    "set MARVI_MESSAGING_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("MARVI_MESSAGING_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
