#!/usr/bin/env python3
"""
SWE Runner with Marvi Trajectory Format

A runner that uses Marvi Messaging's built-in execution environments
(local, docker, modal) and outputs trajectories in the Marvi Messaging format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Marvi Messaging's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Marvi format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Marvi Messaging format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Marvi Messaging's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Marvi Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Marvi Messaging's built-in execution environments
    and outputs trajectories in Marvi Messaging format.
    """
    ...
    def _convert_to_marvi_format(
        ...
        """
        Convert internal message format to Marvi trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Marvi trajectory format
        trajectory = self._convert_to_marvi_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Marvi trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Marvi Trajectory Format")
    print("=" * 60)
