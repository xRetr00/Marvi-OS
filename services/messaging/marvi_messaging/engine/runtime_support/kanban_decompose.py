...
Invoked by ``marvi kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Marvi Messaging board.
...
def _profile_author() -> str:
    """Mirror of ``runtime_support.kanban._profile_author``."""
    return (
