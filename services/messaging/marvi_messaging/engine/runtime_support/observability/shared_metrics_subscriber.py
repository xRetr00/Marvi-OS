"""Relay subscriber for the persisted Marvi shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Marvi counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Marvi shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
