...
``MARVI_MESSAGING_HOME/cache/`` with a TTL, with a bundled seed file as the offline
...
DEFAULT_INDEX_URL = (
    "https://raw.githubusercontent.com/NousResearch/marvi-plugin-index/main/index.json"
)
...
def _cache_path() -> Path:
    return get_marvi_home() / "cache" / "plugin_index.json"
