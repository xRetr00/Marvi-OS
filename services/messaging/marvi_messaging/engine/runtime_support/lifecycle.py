"""Marvi lifecycle dispatch for first-party observers and plugins."""
...
def has_hook(hook_name: str) -> bool:
    ...
    try:
        from runtime_support.observability import handles_hook
