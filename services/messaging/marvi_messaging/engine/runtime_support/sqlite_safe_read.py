...
Marvi is exactly the topology this hits: gateway, dispatcher, dashboard,
...
class _TrackingMixin:
    ...
    _marvi_tracked_path: str | None = None

    def close(self) -> None:  # type: ignore[misc]
        with _live_lock:
            path = getattr(self, "_marvi_tracked_path", None)
    ...
    **kwargs,
    ...
    with _live_lock:
        ...
        try:
            ...
            conn._marvi_tracked_path = resolved
