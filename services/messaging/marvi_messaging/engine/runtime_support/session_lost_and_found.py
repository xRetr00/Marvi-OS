...
``marvi sessions recover --allow-partial`` normally copies rows through SQL,
...
rows back into a fresh current-schema Marvi session database.
...
# Marvi session ids are timestamps: 20260812_135332_ab12cd. This is the
...
def _cli_supports_recover(binary: str) -> bool:
    ...
    scratch_dir = tempfile.mkdtemp(prefix="marvi-recover-probe-")
