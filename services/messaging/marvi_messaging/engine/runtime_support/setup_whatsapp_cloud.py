...
Entry point: ``marvi whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``runtime_support/main.py``).
...
Marvi gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Marvi to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Marvi needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Marvi gateway in another terminal:")
    print("         marvi gateway")
    print()
