...
Design notes / invariants (same contract as ``runtime_support/goals.py``):
...
- This module has zero hard dependency on ``cli.MarviCLI``, the gateway
...
def _get_session_db() -> Optional[Any]:
    """One SessionDB per MARVI_MESSAGING_HOME (same pattern as goals._get_session_db)."""
    try:
