"""Default SOUL.md template seeded into MARVI_MESSAGING_HOME on first run."""
...
#
# Both Marvi (upstream) and Marvi historical templates are listed so users
# who installed under either name get the seamless upgrade.
_LEGACY_TEMPLATE_SOULS = (
    # --- Marvi-era templates (upstream originals) ---
    (
