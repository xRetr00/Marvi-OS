...
supported components into records consumed by Marvi' existing skill and MCP
...
def _translate_remote(config: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    The returned record targets Marvi' existing URL-based MCP runtime.
...
def has_enabled_agent_plugin_mcp(raw_config: Mapping[str, Any]) -> bool:
    ...
    Directory scanning belongs to :mod:`runtime_support.plugins` so startup gating
    ...
    from runtime_support.plugins import has_enabled_agent_plugin_mcp as _probe
