...
This module deliberately has no module-level imports from ``runtime_support.config``
...
def resolve_ephemeral_system_prompt(cfg: Optional[Dict[str, Any]]) -> str:
    ...
    prefer ``MARVI_MESSAGING_EPHEMERAL_SYSTEM_PROMPT`` when that env var is set.
    """
...
def persist_personality(value: Any) -> bool:
    ...
    MARVI_MESSAGING_HOME config.yaml atomically, preserving comments and ordering.
