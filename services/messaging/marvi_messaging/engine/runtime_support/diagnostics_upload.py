"""Client for uploading ``marvi debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``marvi debug share``.
...
NAS_BASE = os.environ.get(
    "MARVI_MESSAGING_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "marvi-messaging/debug-share"
