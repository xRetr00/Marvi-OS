...
Used by ``marvi profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``runtime_support/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Marvi Messaging kanban board.
...
Rules:
  ...
  - Never write "Marvi Messaging profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_marvi_home())
        else:
