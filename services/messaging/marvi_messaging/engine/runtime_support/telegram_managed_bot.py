...
DEFAULT_MANAGER_BOT = "MarviSetupBot"

DEFAULT_BOT_NAME = "Marvi Messaging"
...
def generate_username_slug(length: int = 16) -> str:
    ...
    keeping ``marvi_<slug>_bot`` under Telegram's 32-character username limit.
    """
...
def generate_bot_username(profile_name: Optional[str] = None) -> str:
    """Generate a secure suggested bot username like ``marvi_<slug>_bot``.
    ...
    """
    _ = profile_name
    return f"marvi_{generate_username_slug()}_bot"
