"""``marvi uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Marvi Messaging",
        description="Remove Marvi Messaging from your system. Can keep configs/data for reinstall.",
    )
