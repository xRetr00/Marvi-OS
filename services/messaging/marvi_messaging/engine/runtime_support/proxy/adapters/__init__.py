...
from runtime_support.proxy.adapters.base import UpstreamAdapter
from runtime_support.proxy.adapters.nous_portal import NousPortalAdapter
from runtime_support.proxy.adapters.xai import XAIGrokAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``marvi proxy start --provider <name>`` CLI flag.
