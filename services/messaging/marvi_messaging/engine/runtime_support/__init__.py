"""
Marvi CLI - Unified command-line interface for Marvi Messaging.

Provides subcommands for:
- marvi chat          - Interactive chat (same as ./marvi)
- marvi gateway       - Run gateway in foreground
- marvi gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `marvi setup` on a fresh Pi.
    ...
    runtime_support/stdio.py::configure_windows_stdio() runs later from the entry
