"""
Skills configuration for Marvi Messaging.
`marvi skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.marvi/config.yaml under:
...
from runtime_support.config import cfg_get, load_config, save_config
from runtime_support.colors import Colors, color
from runtime_support.platforms import PLATFORMS as _PLATFORMS
