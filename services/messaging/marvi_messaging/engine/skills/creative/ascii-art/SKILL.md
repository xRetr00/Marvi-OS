...
```bash
python -m pyfiglet "MARVI" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=MARVI&font=Slant" | boxes -d stone
```
