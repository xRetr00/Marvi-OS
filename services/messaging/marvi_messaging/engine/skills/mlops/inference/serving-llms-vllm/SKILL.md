...
vllm serve meta-llama/Meta-Llama-3-8B-Instruc\
  --gpu-memory-utilization 0.9\
  --max-model-len 8192\
  --port 8000

# For 30B-70B models with tensor parallelism
vllm serve meta-llama/Meta-Llama-3-70B-Instruc\
...
docker run --gpus all -p 8000:8000\
  vllm/vllm-openai:lates\
  --model meta-llama/Meta-Llama-3-8B-Instruc\
  --gpu-memory-utilization 0.9\
  --enable-prefix-caching
```
