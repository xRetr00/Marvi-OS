/**
 * Marvi desktop plugin template. Save as:
 *   <marvi home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <marvi home> is ~/.marvi by default, or ~/.marvi/profiles/<name>
 * when running a named profile (`marvi -p <name>`). Run `marvi doctor` (or
 ...
 * Only these imports resolve: @marvi/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@marvi/plugin-sdk'
