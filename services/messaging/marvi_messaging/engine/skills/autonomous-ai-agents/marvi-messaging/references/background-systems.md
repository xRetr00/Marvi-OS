...
User docs: https://github.com/xRetr00/Marvi-OS/docs/user-guide/features/cron
...
- **CLI:** `marvi curator <verb>` — `status`, `usage`, `run`, `pause`,
...
User docs: https://github.com/xRetr00/Marvi-OS/docs/user-guide/features/curator
...
User docs: https://github.com/xRetr00/Marvi-OS/docs/user-guide/features/kanban
