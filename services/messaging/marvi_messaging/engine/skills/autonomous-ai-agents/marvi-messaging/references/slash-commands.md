...
Registry of record: `runtime_support/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Marvi config+state snapshots (CLI)
