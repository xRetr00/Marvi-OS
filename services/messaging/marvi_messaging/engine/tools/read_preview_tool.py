#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the Marvi desktop GUI.
...
def read_preview_tool(
    ...
    if callback is None:
        return tool_error("read_preview is only available in the Marvi desktop app.")
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "Marvi desktop GUI (the pane open_preview opens beside this chat). Call "
