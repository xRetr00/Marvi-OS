...
Only included in the marvi-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Marvi Messaging (https://github.com/xRetr00/Marvi)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_marvi_home() / "cache" / "discord_capabilities.json"
