...
# (MARVI_MESSAGING_HOME env var changes) are always respected.  The old module-level
...
class MemoryStore:
    ...
    def format_for_system_prompt(self, target: str) -> Optional[str]:
        ...
        in the decay sidecar (``MARVI_MESSAGING_HOME/memory/surfaced.json`` — see
