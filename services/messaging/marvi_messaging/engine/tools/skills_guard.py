...
Trust levels:
  - builtin:   Ships with Marvi. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.marvi/\.env|\~/\.marvi/\.env',
     "marvi_env_access", "critical", "exfiltration",
     "directly references Marvi secrets file"),
    ...
    (r'\.marvi/config\.yaml|\.marvi/SOUL\.md',
     "marvi_config_mod", "critical", "persistence",
     "references Marvi configuration files directly"),
...
# scan. `.skillignore` is the Marvi-native name; `.clawhubignore` is honored
