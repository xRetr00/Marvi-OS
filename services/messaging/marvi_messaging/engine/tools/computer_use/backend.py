...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of xRetr00/Marvi-OS#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of xRetr00/Marvi-OS#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (xRetr00/Marvi-OS#67052). ``ok`` stays
