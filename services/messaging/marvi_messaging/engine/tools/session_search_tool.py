...
the get_anchored_view / get_messages_around primitives in marvi_state.
...
# Third-party integrations tag their sessions with MARVI_MESSAGING_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Marvi conversation history only. It is not evidence "
        ...
        "reformat it as a markdown link or wrap it in backticks. Marvi renders "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Marvi conversation history itself, such "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another Marvi profile's database "
