...
def _profile_user_agent() -> str:
    """Return a ``marvi-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from runtime_support import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"marvi-cli/{_ver}"
    except Exception:
        return "marvi-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # marvi-cli UA so the catalog endpoint is reachable.
